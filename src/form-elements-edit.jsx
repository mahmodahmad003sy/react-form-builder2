...
export default class FormElementsEdit extends React.Component {
  ...
  render() {
    ...
    const this_checked = this.props.element.hasOwnProperty("required")
      ...
      : false;
    const sentEmailTo = this.props.element.hasOwnProperty("sentEmailTo")
      ? this.props.element.sentEmailTo
      : false;
    ...
    console.log({ canHaveSendEmailTo });
          ...
          <div className="form-group">
            ...
            {canHaveSendEmailTo && (
              <div className="custom-control custom-checkbox">
                ...
                />
                <label className="custom-control-label" htmlFor="sentEmailTo">
                  <IntlMessages id="sentEmailTo" />
                </label>
              </div>
            )}
